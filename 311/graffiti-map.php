...
<head>
    ...
    <title>Graffiti Service Map</title>
...
<div class="container-fluid">
	    ...
	    <form class="form-inline form-responsive">
          <div class="input-group dropdown">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
             <option value="graffiti-map.php" selected>Graffiti</option>
             <option value="potholes-map.php">Pot Holes</option>
	      ...
	      <div class="input-group dropdown">
            ...
            <a href="../311/graffiti-monthly.php" class="btn btn-primary">
		      Graffiti Charts
            </a>
		</form>  
	  </div>
	    ...
	    <div class="row dash-responsive">
	      ...
	      <div class="col-sm-12">
	          ...
	          <div class="col-md-8 col-sm-8 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Neighborhood Graffiti Map: Last 90 Days  <span class="chart-title"></span> 
	              </div>
	              <div class="chart-stage">
                      <div id="map"></div>
	              </div>
	              <div class="chart-notes">
					<a href="https://data.cityofchicago.org/Service-Requests/311-Service-Requests-Graffiti-Removal/hec5-y4x5">Data Source</a>   |	<a href="http://communitydataproject.org/issue">Report Issue</a> 
	              </div>
	            </div>
	          </div>
            <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Graffiti Surface Filter   <small><a id="surface">Reset</a></small>
	              </div>
	              <div class="chart-stage">
	              ...
	              <div class="chart-notes">
	                Select surface types to filter
	              </div>
	            </div>
	       </div>    
	          <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
    ...
    <script type="text/javascript" src="js/graffiti.map.js"></script>
