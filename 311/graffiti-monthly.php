...
<head>
    ...
    <title>Graffiti Removal per Month</title>
...
<div class="container-fluid">
	    ...
	    <form class="form-inline form-responsive">
          <div class="input-group dropdown">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
             <option value="graffiti-monthly.php" selected>Graffiti</option>
	      ...
	      <div class="input-group dropdown">
            ...
            <a href="../311/graffiti-map.php" class="btn btn-warning">
		      Graffiti Maps
            </a>
		</form>
	  </div>
	          ...
	          <div class="col-md-8 col-sm-12 col-xs-12 line-chart nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Graffiti Removal Requests per Month  <span class="chart-title"></span>   
	              </div>
    ...
    <script type="text/javascript" src="js/graffiti.monthly.js"></script>
</body>
</html>