...
<head>
    ...
    <title>Pot Holes Service Map</title>
...
<div class="container-fluid">
	    ...
	    <form class="form-inline form-responsive">
          <div class="input-group dropdown">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
             <option value="graffiti-map.php">Graffiti</option>
             <option value="potholes-map.php" selected>Pot Holes</option>
             <option value="vacant-map.php">Vacant/Abandoned Buildings</option>
            </select>
          </div>    
	      <div class="input-group dropdown">
            ...
            <a href="../311/potholes-monthly.php" class="btn btn-primary">
		      Pot Holes Charts
            </a>
		</form>  
	  </div>
	    ...
	    <div class="row dash-responsive">
	      ...
	      <div class="col-sm-12">
	          ...
	          <div class="col-md-8 col-sm-8 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Neighborhood Pot Holes Map: Last 90 Days  <span class="chart-title"></span> 
	              </div>
	              <div class="chart-stage">
                      <div id="map"></div>
	              </div>
	              <div class="chart-notes">
					<a href="https://data.cityofchicago.org/Service-Requests/311-Service-Requests-Pot-Holes-Reported/7as2-ds3y">Data Source</a>   |	<a href="http://communitydataproject.org/issue">Report Issue</a> 
	              </div>
	            </div>
	          </div>
            <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Most Recent Action Filter   <small><a id="surface">Reset</a></small>
	              </div>
	              <div class="chart-stage">
					  <svg id="dc-surface-chart" viewBox="0 0 350 300" 
					       preserveAspectRatio="xMidYMid meet">
					  </svg>
	              </div>
	              <div class="chart-notes">
	                Select action types to filter
	              </div>
	            </div>
	       </div>    
	          <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Status (Completed/Open)  <small><a id="status">Reset</a></small>
	              </div>
    ...
    <script type="text/javascript" src="js/potholes.map.js"></script>
