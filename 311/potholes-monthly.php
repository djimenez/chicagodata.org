...
<head>
    ...
    <title>Pot Holes Reported per Month</title>
...
<div class="container-fluid">
	    ...
	    <form class="form-inline form-responsive">
          <div class="input-group dropdown">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
             ...
             <option value="potholes-monthly.php" selected>Pot Holes</option>
             <option value="vacant-monthly.php">Vacant/Abandoned Buildings</option>
            </select>
          </div>    
	      <div class="input-group dropdown">
            ...
            <a href="../311/potholes-map.php" class="btn btn-warning">
		      Pot Holes Maps
            </a>
		</form>  
	  </div>
	          ...
	          <div class="col-md-8 col-sm-12 col-xs-12 line-chart nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Pot Hole Service Requests per Month  <span class="chart-title"></span>   
	              </div>
    ...
    <script type="text/javascript" src="js/potholes.monthly.js"></script>
