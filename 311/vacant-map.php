...
<head>
    ...
    <title>Vacant/Abandoned Buildings Map</title>
...
<div class="container-fluid">
	    ...
	    <form class="form-inline form-responsive">
          <div class="input-group dropdown">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
             ...
             <option value="vacant-map.php" selected>Vacant/Abandoned Buildings</option>
            </select>
          </div>    
	      <div class="input-group dropdown">
            ...
            <a href="../311/vacant-monthly.php" class="btn btn-primary">
                Vacant Building Charts
            </a>
		</form>  
	  </div>
	          ...
	          <div class="col-md-8 col-sm-8 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Vacant/Abandoned Buildings Map: Last 90 Days  <span class="chart-title"></span> 
	              </div>
    ...
    <script type="text/javascript" src="js/vacant.map.js"></script>
