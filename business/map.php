...
<head>
    ...
    <title>Business Licenses Map</title>
...
<div class="container-fluid">
	  <div class="container-fluid form-top dash-responsive">
	    <form class="form-inline form-responsive">  
	      <div class="input-group dropdown">
            ...
            <a href="../business/monthly.php" class="btn btn-primary">
		      Business Charts
            </a>
		</form>  
	  </div>
	          ...
	          <div class="col-md-8 col-sm-8 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Business Licenses Map: Last 90 days (by License Start Date)  <span class="chart-title"></span> 
	              </div>
	          ...
	          <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
	            <div class="chart-wrapper">
	              ...
	              <div class="chart-stage capitalize">
					  <svg id="dc-type-pie" viewBox="-100 0 400 200"
					       preserveAspectRatio="xMidYMid meet">
					  </svg>
	              </div>
	              <div class="chart-notes">
    ...
    <script type="text/javascript" src="js/business.map.js"></script>
