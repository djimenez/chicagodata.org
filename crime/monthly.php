...
<head>
    ...
    <title>Crimes Reported per Month</title>
...
<div class="container-fluid">
	      ...
	      <div class="col-md-12 col-sm-12">
	        <div class="row">
	          <div class="col-md-8 col-sm-12 col-xs-12 line-chart nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Crimes Reported per Month  <span class="chart-title"></span> 
	              </div>
	          ...
	          <div class="col-md-2 col-sm-2 col-xs-3 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Arrest  <small><a id="arrest">Reset</a></small>
	              </div>
	              <div class="chart-stage capitalize">
					  <svg id="dc-arrest-pie" viewBox="0 0 150 150" 
					       preserveAspectRatio="xMidYMid meet">
					  </svg>
	              </div>
	              <div class="chart-notes">
	          ...
	          <div class="col-md-2 col-sm-2 col-xs-3 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Domestic   <small><a id="domestic">Reset</a></small>
	              </div>
	              <div class="chart-stage capitalize">
					  <svg id="dc-domestic-pie" viewBox="0 0 150 150" 
					       preserveAspectRatio="xMidYMid meet">
					  </svg>
	              </div>
	              <div class="chart-notes">
	          ...
	          <div class="col-md-4 col-sm-4 col-xs-6 nopadding">
	            <div class="chart-wrapper">
	              <div class="chart-title-dash">
	                Time of Day Filter   <small><a id="time">Reset</a></small>
	              </div>
	              <div class="chart-stage">
    ...
    <script type="text/javascript" src="js/crime.monthly.js"></script>
</body>
</html>
